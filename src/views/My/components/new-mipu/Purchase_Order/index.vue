<template>
  <div class="order">
    <tops>
      ...
      <div slot='center' class="title">采购订单</div>
    </tops>
        ...
        <van-tab title="全部"  >
          <div class="whole">
            ...
            <div class="no" v-else>
              ...
              <p class="text">暂无数据</p>
              <div class="oDiv">
                <router-link to="/my/mipu_home/new/wholesale_mall/index">快去采购吧</router-link>
              </div>
            </div>
          </div>
        </van-tab>
        <van-tab title="待付款">
          <div class="whole">
            ...
            <div class="no" v-else>
              ...
              <p class="text">暂无数据</p>
              <div class="oDiv">
                <router-link to="/my/mipu_home/new/wholesale_mall/index">快去购物吧</router-link>
              </div>
            </div>
          </div>
        </van-tab>
