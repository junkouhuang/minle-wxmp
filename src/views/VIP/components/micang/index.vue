<template>
  <div class="mipu_card">
    <tops>
      ...
      <div slot='center' class="title">开通米仓</div>
    </tops>
    ...
    <div class="mi_vip_list">
      <van-row class="content00">
        <van-col span="24" class="item">
          <div style="width: 100%;">
              <div style="float:left;width:auto;"><img src="./images/mi_vip04.png"></div>
              <div style="float:left;width:80%;margin-left:15px;padding-top:5px;">
                <p style="color:#333333;font-size:15px;">白米奖励</p>
                <p style="margin-top:10px;color:#7D7E80;font-size:12px;">奖励30000白米，优惠多多。</p>
              </div>
          </div>
        </van-col>
        <van-col span="24" class="item">
        ...
        <van-col span="24" class="item">
          <div style="width: 100%;">
              <div style="float:left;width:auto;"><img src="./images/mi_vip09.png"></div>
              <div style="float:left;width:80%;margin-left:15px;padding-top:5px;">
                <p style="color:#333333;font-size:15px;">免费开店</p>
                <p style="margin-top:10px;color:#7D7E80;font-size:12px;">免费赠送云仓米铺开店权益一次，可自营开店。</p>
              </div>
          </div>
        </van-col>
      </van-row>
        ...
        methods:{
          ...
          async buyNow() {
            let res = await this.$http({
              ...
              data: {commodityNoList: ['58209736478512']}
            })
            if (res.status == 200) {
...
.mipu_card {
  ...
  .car_img {
    background: url('./images/vip_card_mic.png') no-repeat center center;
