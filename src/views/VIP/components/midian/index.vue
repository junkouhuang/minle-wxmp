        ...
        <van-col span="24" class="item">
          <div style="width: 100%;">
              ...
              <div style="float:left;width:80%;margin-left:15px;padding-top:5px;">
                ...
                <p style="margin-top:10px;color:#7D7E80;font-size:12px;">奖励300白米，优惠多多。</p>
              </div>
          </div>
        </van-col>
        <van-col span="24" class="item">
        ...
        methods:{
          ...
          async buyNow() {
            let res = await this.$http({
              ...
              data: {commodityNoList: ['58209736478511']}
            })
            if (res.status == 200) {
...
.mipu_card {
  ...
  .car_img {
    background: url('./images/vip_card_md.png') no-repeat center center;
